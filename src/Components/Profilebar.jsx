    ...
    >
      ...
      >
        ...
        <div className={`w-full ${screenWidth<1200 || activeMenuItem === "Report"?"h-full":"h-5/6 "}`}>
          ...
          {(activeMenuItem === "Report" && patlis === 'false') &&(<Report userId={userID} onDashboard={()=> handleMenuItemClick("Dashboard")}  onRegimeClick={(patientId) => onRegimeClick(patientId)}  onAssessmentClick={(patientId) => handleMenuItemClick("Analysis",patientId)} />)}
